GAGE LANGUAGE SPECIFICATION AND COMPILER ARCHITECTURE
Core Language Design, Lexical Grammar, Memory Model, and Compiler Internals
Classification: Technical Specifications Manual
