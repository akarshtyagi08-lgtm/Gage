...
void tokenize() {
    while (src_pos < src_len) {
        ...
        if (isalpha(c) || c == '_') { 
            ...
            if (strcmp(t.value, "print") == 0) t.type = TOKEN_PRINT; else if (strcmp(t.value, "let") == 0) t.type = TOKEN_LET; else if (strcmp(t.value, "OR") == 0) t.type = TOKEN_OR_OP; else if (strcmp(t.value, "import") == 0) t.type = TOKEN_IMPORT; else t.type = TOKEN_IDENT; 
